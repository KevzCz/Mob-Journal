// src/main/java/net/pixeldreamstudios/journal/JournalEvents.java
...
public class JournalEvents {
    public static void init() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(OpenJournalPayload.ID, (payload, context) -> {
            ...
            ServerPlayNetworking.send(player, new SyncJournalPayload(comp.getDiscovered().stream().toList()));
